import type { ListContext, Options, RouterData, RouterResType } from "../types.js";
...
const getList = async (options: Options, noCache: boolean): Promise<RouterResType> => {
    ...
    const list = result.data.data[(listType as Record<string, keyof typeof result.data.data>)[type || "hot"]];
    return {
        ...result,
